    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-3 md:px-6 flex items-center justify-between w-full h-full">
            ...
            <div className="flex gap-2 md:gap-4">
                <button
                    onClick={onMark}
                    className={`w-10 h-10 md:w-auto md:h-auto md:px-4 md:py-2 flex items-center justify-center gap-2 rounded-xl border transition-colors ${isMarked
            ...
            <button
                onClick={onNext}
                disabled={false} // Always enable finish to allow partial submission
